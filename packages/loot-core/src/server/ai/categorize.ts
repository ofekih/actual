...
4. Provide a 'reasoning' string explaining your choice briefly.
5. If you are highly confident (e.g., > 0.9) that this Payee should ALWAYS be mapped to these categories, set 'suggest_rule' to true.`;
